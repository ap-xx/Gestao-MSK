...
const DB_KEYS = {
  ...
  initialized: 'msk_initialized_v2',
};
  ...
  const processos: Processo[] = [
    {
      ...
      ultimaMovimentacao: '2025-07-01',
      status: 'ativo',
      criadoEm: '2024-01-15T10:00:00Z',
      atualizadoEm: '2025-07-01T00:00:00Z',
    },
    {
      id: 'p2',
      ...
      ultimaMovimentacao: '2025-06-20',
      status: 'ativo',
      criadoEm: '2024-03-05T09:00:00Z',
      atualizadoEm: '2025-06-20T00:00:00Z',
    },
    {
      id: 'p3',
      ...
      valorCausa: 2000000,
      audiencias: [],
      ultimaMovimentacao: '2025-07-05',
      status: 'ativo',
      criadoEm: '2024-01-20T11:00:00Z',
      atualizadoEm: '2025-07-05T00:00:00Z',
    },
  ];
  ...
  const lancamentos: Lancamento[] = [
    {
      ...
      clienteNome: 'João Carlos Mendonça',
      contratoId: 'ct1',
      descricao: 'Honorários mensais — Junho/2025',
      valor: 3500,
      dataVencimento: '2025-06-05',
      dataPagamento: '2025-06-04',
      status: 'pago',
      formaPagamento: 'PIX',
    ...
    },
    {
      id: 'l7',
      tipo: 'despesa',
      descricao: 'Aluguel do escritório — Julho/2025',
      valor: 8500,
      dataVencimento: '2025-07-05',
      status: 'pendente',
      criadoEm: '2025-07-01T00:00:00Z',
    },
    {
      ...
      dataPagamento: '2025-06-14',
      status: 'pago',
      criadoEm: '2025-06-10T00:00:00Z',
    },
    {
      id: 'l9',
      tipo: 'recebimento',
  ...
  const avisos: Aviso[] = [
    {
      ...
      urgencia: 'critica',
      processoId: 'p1',
      dataLimite: '2025-07-20',
      lido: false,
      criadoEm: '2025-07-17T08:00:00Z',
    },
    {
      id: 'av2',
      titulo: 'Audiência agendada',
      descricao: 'Audiência de Instrução — João Carlos Mendonça em 15/08/2025 às 14h.',
      tipo: 'audiencia',
      urgencia: 'alta',
      processoId: 'p1',
      dataLimite: '2025-08-15',
      lido: false,
      criadoEm: '2025-07-10T09:00:00Z',
    },
    {
      id: 'av3',
    ...
    },
    {
      ...
      clienteId: 'c5',
      lido: false,
      criadoEm: '2025-07-05T00:00:00Z',
    },
    {
      id: 'av5',
      titulo: 'Audiência de Conciliação',
      descricao: 'Maria Fernanda Costa — Audiência em 10/09/2025 às 10h30.',
      tipo: 'audiencia',
      urgencia: 'media',
      processoId: 'p2',
      dataLimite: '2025-09-10',
      lido: true,
      criadoEm: '2025-07-08T00:00:00Z',
    },
  ];
